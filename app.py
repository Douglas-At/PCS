...
####### PRECISAR DE CODIGO QUE COLOCA A CADA REFRESH O SERIAL MONITOR LINKANDO AO DATA BASE PARA SER CAPAZ DE AO BAIXAR O CSV já estar 100% atualizado
#parte crucial para poder atualizar a db do projeto e extrair 
